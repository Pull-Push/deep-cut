...
export default function ArtistCard({ artist }){
    ...
    return(
        <div onClick={() => router.push(`/discover?q=${artist.name}`)} className="flex flex-col items-center gap-2 p-4 rounded-xl bg-zinc-900 hover:bg-zinc-800 transition-colors cursor-pointer">
