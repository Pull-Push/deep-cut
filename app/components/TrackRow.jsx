...
export default function TrackRow({ track, index }) {
    ...
    return(
        <div onClick={() => router.push(`/track?artist=${typeof track.artist === 'object' ? track.artist.name : track.artist}&track=${track.name}`)} className="flex items-center gap-4 p-3 rounded-xl bg-zinc-900 hover:bg-zinc-800 transition-colors cursor-pointer">
